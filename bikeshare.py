...
def get_filters():
    ...
    """
    print('Hi buddy! Let\'s begin our journey with having a look at some US bikeshare data!')
    # get user input for city (chicago, new york city, washington). HINT: Use a while loop to handle invalid inputs
    while True:
        city = input("Which city would you like to inquire into?")
        city = city.lower()
    ...
    while True:    
        month = input("In a six-month intervals, do you need a detailed information about specific months of coverage? If yes, type month name from within first six months else type 'all'")
        month = month.lower()
    ...
    while True:
        day = input("A detailed information for a specific day is required? If yes, type day name else type 'all'")
        day = day.lower()
